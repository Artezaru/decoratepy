...
def read_version():
    version_file = os.path.join(os.path.dirname(__file__), 'decoratepy', '__version__.py')
    with open(version_file) as f:
        exec(f.read()) 
    return locals()['__version__']

setup(
    name="decoratepy",  # Replace with your package name
    ...
    url="https://github.com/Artezaru/decoratepy.git",  # URL to the project repository
